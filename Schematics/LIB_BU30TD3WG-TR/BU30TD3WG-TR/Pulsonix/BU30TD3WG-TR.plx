...
(library Library_1
	...
	(compDef "BU30TD3WG-TR" (originalName "BU30TD3WG-TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix PS)
		...
		(compPin "3" (pinName "STBY") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/BU30TD3WG-TR.pdf")
		(attr "<Component Height>" "1.25")
		(attr "<STEP Filename>" "BU30TD3WG-TR.stp")
